                        ...
                        <div class="mt-5">
                            ...
                            <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                ...
                                <div class="w-full mt-3 xl:mt-0 flex-1">
                                    <input id="projet-nom" name="nom" type="text" class="form-control" placeholder="Nom du projet" required>
                                ...
                                <div class="form-label xl:w-64 xl:!mr-10">
                                    <div class="text-left">
                                        <div class="flex items-center">
                                            ...
                                            <button class="btn btn-primary w-44" data-tw-toggle="modal" data-tw-target="#new-order-modal-structure-porteuse">
                                ...
                                <div class="w-full mt-3 xl:mt-0 flex-1">
                                    <div class="flex flex-col sm:flex-row">
                                        <div class="form-check mr-4">
                                            ...
                                            <label class="form-check-label" for="statut-en-cour">En cour</label>
                                        </div>
    ...
    <div id="new-order-modal-structure-porteuse" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="Structure_porteuse" action="{{ route('structure-porteuse.storeStructureporteuse') }}" method="POST">
                @csrf
    ...
    <div id="new-order-modal-equipe" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="equipe_form" action="{{ route('equipe.storeEquipe') }}" method="POST" >
                @csrf
    <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
        <div class="col-span-12">
