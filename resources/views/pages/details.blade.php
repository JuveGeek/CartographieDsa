...
@section('subcontent')
    ...
    <!-- BEGIN: amendements-->
    <h2 class="intro-y text-lg font-medium mt-10">Amendements du projet : {{ $projet->nom }} </h2>
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            ...
            <form id="amendement-form" method="POST" action="{{ route('amendements.store') }}"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                        ...
                        <div class="col-span-12">
                            <label for="amendement-source" class="form-label">Source</label>
                            <input id="amendement-source" name="source" type="text" class="form-control flex-1"
                                placeholder="Entrez la source de l'amendement">
                        </div>
                        ...
                        <!-- Statut -->
                        <div class="col-span-12">
                            <label for="amendement-statut" class="form-label">Statut</label>
                        ...
                        <div class="col-span-12">
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <button type="button" class="btn btn-outline-primary"
                                    ...
                                    fichier</button>
                                <span id="file-name-amendement" class="text-gray-500">Aucun fichier sélectionné</span>
                            </div>
                        </div>
    ...
    <!-- BEGIN: Difficultes-->
    <h2 class="intro-y text-lg font-medium mt-10">Difficultés du projet : {{ $projet->nom }} </h2>
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
